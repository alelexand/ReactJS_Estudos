...
class Header extends Component {
  render() {
    return <header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
            <link href="https://getbootstrap.com/docs/4.6/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-xOolHFLEh07PJGoPkLv1IbcEPTNtaed2xpHsD9ESMhqIYd0nLMwNLD69Npy4HI+N" crossorigin="anonymous"></link>
            <link href="https://getbootstrap.com/docs/4.6/assets/css/docs.css" rel="stylesheet"></link>
              ...
              <ul class="navbar-nav ml-md-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link pl-2 pr-1 mx-1 py-3 my-n2" href="https://github.com/alelexand" target="_blank" rel="noopener" aria-label="GitHub">
